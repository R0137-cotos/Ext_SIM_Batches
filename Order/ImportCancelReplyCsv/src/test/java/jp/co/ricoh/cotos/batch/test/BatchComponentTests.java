...
@SpringBootTest
public class BatchComponentTests extends TestBase {
	...
	@Test
	public void 正常系_リプライCSV取込解約() throws Exception {
		...
		batchComponent.execute(new String[] { "src/test/resources/csv", "reply.csv" });
	}
