...
echo ""
echo "--1234"
echo "Content-Type: text/plain; name=`date "+%Y%m%d"`_SIM_kaiyaku.csv"
echo "Content-Transfer-Encoding: base64"
echo "Content-Disposition: attachment; filename=`date "+%Y%m%d"`_SIM_kaiyaku.csv"
echo ""
cat $1 | base64
echo ""
echo "--1234--"
echo "."
echo "QUIT"
} | python -m telnetlib 10.237.225.216 25 2>> $4
